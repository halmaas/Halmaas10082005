...
deposit money, withdraw money, and display the account.Ensure that the account balance.
cannot be  accessed directly from  outside the class.Write a program to create an instance of the
Bank Account class and test the deposit and withdrawl functionally.'''
